...
public class ScrimInsetsScrollView extends ScrollView {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyle) {
        TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.ScrimInsetsScrollView, defStyleAttr, defStyle);
