...
import joe.com.cnode.ui.listener.FormatJavascriptInterface;
import joe.com.cnode.ui.listener.ImageJavaScriptInterface;
import joe.com.cnode.ui.listener.TopicJavascriptInterface;
import joe.com.cnode.ui.view.IBackToContentTopView;

/**
 * Created by JOE on 2016/8/12.
 */
public class TopicWebView extends CNodeWebView implements IBackToContentTopView {
    ...
    private void updateTopicAndUserId(@NonNull TopicWithReply topic, String userId) {
        if (pageLoaded) {
